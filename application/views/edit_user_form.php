                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <?php echo form_input('usuario', $usuario[0]->usuario); ?>
                            <?php echo form_hidden('id', $usuario[0]->id); ?>
                            <?php echo form_label('Password', 'password'); ?>
                            <?php echo form_password('password', $usuario[0]->pass); ?>
                            <?php echo form_label('Origen', 'origen'); ?>
                            <select name="origen" id="origen">
                                <?php foreach ($origenes as $origen) { ?>
                                    <?php if ($usuario[0]->origen == $origen->id) { ?>
                                        <option value="<?php echo $origen->id; ?>" selected><?php echo $origen->comuna; ?></option>
                                    <?php } else { ?>
                                        <option value="<?php echo $origen->id; ?>"><?php echo $origen->comuna; ?></option>
                                    <?php } ?>
                                <?php } ?>
                            </select>

                            <?php echo form_label('Perfil', 'perfil'); ?>
                            <?php echo form_dropdown('perfil', $perfiles, $usuario[0]->perfil); ?>
                            <?php // echo form_reset('reset', 'Limpiar');?>
